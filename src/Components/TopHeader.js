...
const TopHeader = () => {
    return (
        <div className='header py-5 mb-4'>
            ...
            <div className='row searchbar_wrapper justify-content-lg-center justify-content-md-between align-items-center mx-0 mx-md-5 mt-4'>
